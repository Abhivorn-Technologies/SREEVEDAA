    ...
    <main className="min-h-screen bg-slate-50 pt-24 pb-12 flex flex-col justify-center">
      <div className="page-shell flex flex-col gap-10">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:right-auto sm:w-[280px] bg-white rounded-2xl shadow-2xl p-5 border border-slate-100/50 backdrop-blur-sm">
              ...
              <div className="space-y-3 mb-5">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-800 font-medium leading-tight">
                      201, Second Floor, Shree Plaza,<br />
                      Plot No 1&2, Opp Bobbili Empire,<br />
                      Ruby Block, Kompally,<br />
                      Hyderabad-500100
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[11px] text-slate-700">Phone: <span className="text-slate-800 font-medium">+91 63035 72745</span></p>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[11px] text-slate-700 truncate">Email: <span className="text-slate-800 font-medium truncate">info@sreevedaa.com</span></p>
                </div>
              </div>

              {/* Action Button */}
              <a 
                href="https://maps.app.goo.gl/m6HUnCk5pc3qTJtm9" 
                target="_blank"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full animate-fade-in-up delay-300">
          {/* Email Card */}
          <a href="mailto:info@sreevedaa.com" className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition-all group flex items-center gap-5">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-slate-700 font-light truncate">info@sreevedaa.com</p>
            </div>
          </a>

          {/* Phone Card */}
          <a href="tel:+916303572745" className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition-all group flex items-center gap-5">
            <div className="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center text-theme-gradient shrink-0 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-slate-700 font-light truncate">+91 63035 72745</p>
            </div>
          </a>

          {/* WhatsApp Card */}
          <a href="https://wa.me/916303572745?text=Hello%20Sreevedaa%20Interiors%2C%20I%20would%20like%20to%20inquire%20about%20your%20design%20services." className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition-all group flex items-center gap-5">
            <div className="w-14 h-14 bg-orange-50 rounded-2xl flex items-center justify-center text-theme-gradient shrink-0 group-hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
