  ...
  return (
    <>
              ...
              return (
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-semibold transition-all border-b-2 ${
                    active ? "border-maroon-800 text-maroon-800" : "border-transparent text-slate-600 hover:text-maroon-800"
                  }`}
                >
                  {link.label}
                </Link>
      ...
      >
        ...
        <div 
          className={`absolute top-0 right-0 h-full w-[85%] max-w-[400px] bg-white shadow-2xl flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  onClick={() => setOpen(false)}
                  className={`rounded-xl px-5 py-4 text-[15px] font-medium transition-all ${
                    active ? "bg-slate-50 text-slate-900" : "text-slate-600 hover:text-maroon-800 hover:bg-slate-50/50"
                  }`}
                >
                  {link.label}
                </Link>
